...
import com.hlong.oa.dao.LeaveFormDao;
import com.hlong.oa.dao.NoticeDao;
import com.hlong.oa.dao.ProcessFlowDao;
import com.hlong.oa.entity.Employee;
import com.hlong.oa.entity.LeaveForm;
import com.hlong.oa.entity.Notice;
import com.hlong.oa.entity.ProcessFlow;
import com.hlong.oa.service.exception.BussinessException;
...
public class LeaveFormService {
    ...
    public LeaveForm createLeaveForm(LeaveForm form){
        LeaveForm savedForm = (LeaveForm)MybatisUtils.executeUpdate(sqlSession -> {
            ...
            //3.分情况创建其余流程数据
            //3.1 7级以下员工,生成部门经理审批任务,请假时间大于48小时,还需生成总经理审批任务
